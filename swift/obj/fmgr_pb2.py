...
_VOLUMESTAT = _descriptor.Descriptor(
  name='VolumeStat',
  full_name='filemgr.VolumeStat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='object_count', full_name='filemgr.VolumeStat.object_count', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quarantined_count', full_name='filemgr.VolumeStat.quarantined_count', index=1,
...
_VOLUMESTATS_VOLUMEENTRY = _descriptor.Descriptor(
  name='VolumeEntry',
  full_name='filemgr.VolumeStats.VolumeEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='filemgr.VolumeStats.VolumeEntry.key', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='filemgr.VolumeStats.VolumeEntry.value', index=1,
...
_VOLUMESTATS = _descriptor.Descriptor(
  name='VolumeStats',
  full_name='filemgr.VolumeStats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='volume', full_name='filemgr.VolumeStats.volume', index=0,
  ...
  nested_types=[_VOLUMESTATS_VOLUMEENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_LISTVOLUMESINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_all_volumes', full_name='filemgr.ListVolumesInfo.get_all_volumes', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='repair_tool', full_name='filemgr.ListVolumesInfo.repair_tool', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VOLUMESTATS_VOLUMEENTRY.fields_by_name['value'].message_type = _VOLUMESTAT
_VOLUMESTATS_VOLUMEENTRY.containing_type = _VOLUMESTATS
_VOLUMESTATS.fields_by_name['volume'].message_type = _VOLUMESTATS_VOLUMEENTRY
...
DESCRIPTOR.message_types_by_name['VolumeStat'] = _VOLUMESTAT
DESCRIPTOR.message_types_by_name['VolumeStats'] = _VOLUMESTATS
...
VolumeStat = _reflection.GeneratedProtocolMessageType('VolumeStat', (_message.Message,), dict(
  DESCRIPTOR = _VOLUMESTAT,
  __module__ = 'fmgr_pb2'
  # @@protoc_insertion_point(class_scope:filemgr.VolumeStat)
  ))
_sym_db.RegisterMessage(VolumeStat)

VolumeStats = _reflection.GeneratedProtocolMessageType('VolumeStats', (_message.Message,), dict(

  VolumeEntry = _reflection.GeneratedProtocolMessageType('VolumeEntry', (_message.Message,), dict(
    DESCRIPTOR = _VOLUMESTATS_VOLUMEENTRY,
    __module__ = 'fmgr_pb2'
    # @@protoc_insertion_point(class_scope:filemgr.VolumeStats.VolumeEntry)
    ))
  ,
  DESCRIPTOR = _VOLUMESTATS,
  __module__ = 'fmgr_pb2'
  # @@protoc_insertion_point(class_scope:filemgr.VolumeStats)
  ))
_sym_db.RegisterMessage(VolumeStats)
_sym_db.RegisterMessage(VolumeStats.VolumeEntry)
...
_VOLUMESTATS_VOLUMEENTRY.has_options = True
_VOLUMESTATS_VOLUMEENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
try:
  ...
  class FileMgrStub(object):
    ...
    def __init__(self, channel):
      ...
      self.GetVolumeStats = channel.unary_unary(
          '/filemgr.FileMgr/GetVolumeStats',
          request_serializer=Empty.SerializeToString,
          response_deserializer=VolumeStats.FromString,
          )
  ...
  def add_FileMgrServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'GetVolumeStats': grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=VolumeStats.SerializeToString,
        ),
  ...
  class BetaFileMgrStub(object):
    ...
    def GetVolumeStats(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """Get stats for all volumes. It is costly, but not expected to be called often.
      This will go through the whole DB (objects, quarantined, volumes)
      Because the state of volumes may change during the call, before acting on the result, the caller
      should check that the volume mtime has not changed during the call.
  ...
  def beta_create_FileMgr_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('filemgr.FileMgr', 'GetVolumeStats'): Empty.FromString,
    ...
    response_serializers = {
      ...
      ('filemgr.FileMgr', 'GetVolumeStats'): VolumeStats.SerializeToString,
    ...
    method_implementations = {
      ...
      ('filemgr.FileMgr', 'GetVolumeStats'): face_utilities.unary_unary_inline(servicer.GetVolumeStats),
  ...
  def beta_create_FileMgr_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('filemgr.FileMgr', 'GetVolumeStats'): Empty.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('filemgr.FileMgr', 'GetVolumeStats'): VolumeStats.FromString,
    ...
    cardinalities = {
      ...
      'GetVolumeStats': cardinality.Cardinality.UNARY_UNARY,
